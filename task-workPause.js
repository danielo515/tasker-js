...
"use strict";var e=require("./tasks"),s=require("./dashboard/isEven"),r=require("date-fns"),t=(0,e.pauseTask)("work"),i=t.pauses;if((0,s.isEven)(i.length)){var n=i[i.length-1],a=i[i.length-2];tk.flashLong((0,r.differenceInMinutes)(n,a)+" minutes")}tk.exit();
