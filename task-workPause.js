...
if ((0, _isEven.isEven)(task.paused.length)) {
  var b = task.paused[task.length - 1];
  var a = task.paused[task.length - 2];
  tk.flashLong((0, _dateFns.differenceInMinutes)(a, b) + ' minutes');
}
