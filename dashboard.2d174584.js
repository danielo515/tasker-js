...
var calculateRunningTime = function calculateRunningTime(start, stop, pauses) {
  ...
  return stop ? (0, _dateFns.distanceInWords)(start, (0, _dateFns.subMilliseconds)(stop, discount), {
    includeSeconds: true
  }) : (0, _dateFns.distanceInWordsToNow)(start);
};
