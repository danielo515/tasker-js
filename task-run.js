...
exports.isOdd = isOdd;
},{}],"cSb6":[function(require,module,exports) {
"use strict";
...
var _serialize = function _serialize(d) {
  return JSON.stringify(d, null, 2);
};

var _deserialize = function _deserialize(str) {
...
/*#__PURE__*/
function () {
  function TaskerAdapter(source, _ref) {
    var _ref$serialize = _ref.serialize,
        serialize = _ref$serialize === void 0 ? _serialize : _ref$serialize,
        _ref$deserialize = _ref.deserialize,
        deserialize = _ref$deserialize === void 0 ? _deserialize : _ref$deserialize,
        defaultValue = _ref.defaultValue;

    _classCallCheck(this, TaskerAdapter);
...
},{"buffer":"dskh"}],"ZcPk":[function(require,module,exports) {
...
},{}],"rpNd":[function(require,module,exports) {
'use strict';
...
var _taskerAdapter = _interopRequireDefault(require("./taskerAdapter"));
...
var loadTask = function loadTask(title) {
  var task = _db.db.get('tasks').find({
    title: title
  }).value();
...
},{"./dashboard/isOdd":"PAGD","./database/db":"ms86","./emptyTask":"9Ix2"}],"+qIH":[function(require,module,exports) {
"use strict";
