...
var RowContent = function RowContent(_ref) {
  var title = _ref.title,
      value = _ref.value;
  return _react.default.createElement("div", null, _react.default.createElement(_Typography.default, null, " ", title, " "), _react.default.createElement(_Typography.default, null, " ", value, " "));
};

var Header = _styledComponents.default.span(_templateObject3());

var SecondaryHeader = _styledComponents.default.span(_templateObject4());

var Colum = _styledComponents.default.span(_templateObject5());

var Task = function Task(_ref2) {
  var startedAt = _ref2.startedAt,
      stoppedAt = _ref2.stoppedAt,
      pauses = _ref2.pauses,
      title = _ref2.title;
  ...
  })), _react.default.createElement(Row, null, " ", _react.default.createElement(RowContent, {
    title: "Finished:",
    text: stoppedAt ? (0, _dateFns.distanceInWordsToNow)(stoppedAt) : '-'
  })), _react.default.createElement(Row, null, " ", _react.default.createElement(RowContent, {
    title: "Running:",
    text: runningTime
  }))), _react.default.createElement(_ExpansionPanelDetails.default, null, lastPause && _react.default.createElement(Row, null, " Last pause: ", lastPause, " ago "), _react.default.createElement(Row, null, " ", computedPauses.join(' |-| '), " "))));
};
...
var _default = App;
exports.default = _default;
},{"react":"1n8/","./App.css":"CMr0","./Task":"V/1Z","../tasks":"rzbf","@material-ui/core/Paper":"76mt","../../fixtures/fakeTask":"p+TI"}],"pZkM":[function(require,module,exports) {
"use strict";
